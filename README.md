# RepoSignal: GitHub to LinkedIn Project Visibility Tool

RepoSignal is a proposed SaaS tool that watches a user's GitHub activity, detects when a repository becomes worth sharing, creates LinkedIn-ready project and post content, and publishes approved posts through official LinkedIn APIs.
...
RepoSignal should be unique in five ways:
