    ...
    <div className="min-h-screen bg-black text-white selection:bg-indigo-500/30">
      ...
      <nav className="border-b border-white/10 bg-black/50 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold tracking-tight">RepoSignal</span>
          </div>
      ...
      <main className="relative max-w-7xl mx-auto px-6 pt-32 pb-24 text-center">
        ...
        <p className="relative text-lg md:text-xl text-gray-400 max-w-2xl mx-auto mb-12">
          Automate your professional visibility. RepoSignal securely analyzes your GitHub activity and generates meaningful, human-reviewed project updates for your LinkedIn profile.
        </p>
      ...
      <footer className="border-t border-white/10 py-12 text-center text-gray-500 text-sm">
        <p>&copy; {new Date().getFullYear()} RepoSignal. All rights reserved.</p>
      </footer>
    </div>
  );
}
