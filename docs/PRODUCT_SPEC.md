...
Working name: GitSync

Tagline: Turn real GitHub progress into credible LinkedIn visibility.

## Product Thesis

Developers already do the hard work in GitHub. The missing layer is storytelling, selection, formatting, and publishing. GitSync should detect meaningful project progress, generate professional LinkedIn posts, prepare LinkedIn Projects section content, and publish only when the user has approved the automation level.
