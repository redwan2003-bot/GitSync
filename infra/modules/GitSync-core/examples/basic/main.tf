module "GitSync_core" {
  ...
  api_image    = "012345678912.dkr.ecr.us-east-1.amazonaws.com/GitSync-api:latest"
  worker_image = "012345678912.dkr.ecr.us-east-1.amazonaws.com/GitSync-worker:latest"
  web_image    = "012345678912.dkr.ecr.us-east-1.amazonaws.com/GitSync-web:latest"
  ...
  linkedin_redirect_uri = "https://GitSync.com/api/auth/callback/linkedin"
  web_app_url           = "https://GitSync.com"
}
